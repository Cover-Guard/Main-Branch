...
const schema = z.object({
  ...
  company: z.string().min(1, 'Required for agents'),
    ...
    <div className="flex min-h-screen items-center justify-center bg-brand-900 px-4 py-12">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <h1 className="mt-6 text-2xl font-bold text-white">Create Agent Account</h1>
          <p className="mt-2 text-brand-300">
            Already have an account?{' '}
            <Link href="/agents/login" className="text-white hover:underline">Sign in</Link>
          </p>
        </div>
        ...
        <div className="card p-8">
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-4">
            ...
            <div>
              ...
              <input className="input mt-1" {...register('licenseNumber')} />
            </div>
          ...
          <p className="mt-4 text-center text-xs text-gray-500">
            Are you a homebuyer?{' '}
            <Link href="/register" className="text-brand-600 hover:underline">Register here instead</Link>
          </p>
        </div>
      </div>
    </div>
