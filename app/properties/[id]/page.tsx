...
import { formatAddress, formatCurrency } from '@/lib/shared/types'
import type { Property, PropertyRiskProfile, InsuranceCostEstimate as IInsuranceCostEstimate, CarriersResult, InsurabilityStatus } from '@/lib/shared/types'
